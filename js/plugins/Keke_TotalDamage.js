 ...
 * @desc ヒット数の表示設定
 * @type struct<hit>
 * @default {"位置":"","表示方向":"左","ずらしX":"0","ずらしY":"0","フォント設定":"","フォント":"","文字サイズ":"30","縁取り幅":"8","文字色":"240, 240, 0, 1","縁取り色":"0, 0, 0, 1","ラべル":"","ヒット数ラベル":"Hit","文字色-ラベル":"0, 255, 192, 1","縁取り色-ラベル":"0, 0, 0, 1","ラベル幅":"32","無効":""}
 * 
 * @param ミス回避
 * @parent 付属設定
 * @desc ミス・回避の設定
 ...
 * @desc ヒット数の表示設定
 * @type struct<hit>
 * @default {"位置":"","表示方向":"左","ずらしX":"0","ずらしY":"0","フォント設定":"","フォント":"","文字サイズ":"26","縁取り幅":"7","文字色":"240, 240, 0, 1","縁取り色":"0, 0, 0, 1","ラべル":"","ヒット数ラベル":"Hit","文字色-ラベル":"0, 255, 192, 1","縁取り色-ラベル":"0, 0, 0, 1","ラベル幅":"25","無効":""}
 */
...
(() => {
    ...
    function updateTotalDamagePos(sprite, battlerSprite) {
        ...
        if (asi) {
            ...
            // 位置
            sprite.x = (asi.faceBaseSprite ? asi.faceHomeX + asi.faceOffsetX : battlerSprite._homeX + battlerSprite._offsetX) + offsetX + (sprite._damageCenterXKe || 0);
