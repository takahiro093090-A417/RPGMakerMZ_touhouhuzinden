...
/*:
 * @target MZ
 * @plugindesc Displays the track name when the BGM changes.
 * @author Lulu's Church
 * @url https://nine-yusha.com/plugin-trackname-window/
 *
 * @help LL_TrackNameWindow.js
 *
 * Displays the track name when the BGM changes.
 * Allows you to implement effects commonly seen in adventure games.
 * The track name window will not appear during battles.
 * Use plugin commands to toggle the display state of the track name.
 *
 * Terms of use:
 ...
 *
 * @command setEnabled
 * @text Toggle Track Name Display
 * @desc Toggles the display of the track name ON or OFF.
 *
 * @arg enabled
 * @text Show Track Name
 * @desc If OFF, the track name will not be shown.
 * @default true
 * @type boolean
 *
 * @param trackLists
 * @text Track Name List
 * @desc Defines track names. BGM not in this list will not be displayed.
 * @default []
 ...
 * @param twY
 * @text Y Position
 * @desc The Y position of the window. Recommend 50 or more to avoid overlap
 * with the map name window.
 * @default 50
 * @max 9999
 * @min -9999
 * @type number
 ...
 * @param twTransition
 * @text Animation
 * @desc Select the animation style for the window appearance.
 * @type select
 * @default 3
 * @option Fade
 * @value 1
 ...
 * @desc Duration the window is shown (1/60 sec).
 * @default 150
 * @type number
 *
 * @param twOriginalBg
 * @text Background Image Filename
 * @desc Select a file to use as the background image.
 * @dir img/system
 * @type file
 *
 * @param twTextColor
 * @text Text Color
 * @desc Enter a CSS color code for the text color.
 * @default #ffffff
 * @type string
 *
 * @param twTextBorder
 * @text Text Outline
 * @desc Select the text outline color.
 ...
 * @text Option Name
 * @desc Item name shown in the options menu.
 * Leave blank to hide it from the menu.
 * @default Show Track Name
 * @type string
 */
 ...
 * @param trackFile
 * @text Music Filename
 * @desc Select the BGM file to assign a track name.
 * @dir audio/bgm
 * @type file
 *
 * @param trackName
 * @text Track Name
 * @desc Enter the track name.
 * @default
 * @type string
 */
